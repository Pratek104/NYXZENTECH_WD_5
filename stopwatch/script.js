var start = document.querySelector("#start");
  ...
  function clearLapTimes() {
    ...
    lapList.innerHTML = "";
    lapList.classList.remove("hasBorder");
  }
  ...
  lap.addEventListener("click", function () {
    var lapTime =formatTime(hour)+":" +formatTime(minutes) + ":" + formatTime(seconds) + ":" + formatTime(milliseconds);
    var lapList = document.getElementById("lapTimes");
    var lapItem = document.createElement("div");
    lapItem.innerText = "Lap " + (lapList.childElementCount + 1) + ": " + lapTime;
    lapList.appendChild(lapItem);
    lapList.classList.add("hasBorder");
  });
